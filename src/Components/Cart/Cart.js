...
const Cart = () => {
    ...
    tl.fromTo(".CartItemsTitle", {opacity: 0, y: 30}, {delay: .3, duration: .5, opacity: 1, y: 0})
    tl.fromTo(".CartIcon", {opacity: 0, x: "-100%"}, {duration: .8, opacity: 1, x: "0%"})
    tl.fromTo(".totalValue", {opacity: 0, y: -50}, {duration: .6, opacity: 1, y: 0, ease: "bounce"})
                ...
                <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header CartHeader">
                            ...
                            <h2 className="modal-title text-light fs-2 ps-3 CartItemsTitle" id="exampleModalLabel">ITEMS IN YOUR CART <FaShoppingCart /></h2>
                        ...
                        <div className="modal-footer CartFooter">
                            <h3 className="text-light">Total: <span className="totalValue fs-4 ps-2"><i className="bi bi-currency-dollar"></i>{totalPrice}</span></h3>
